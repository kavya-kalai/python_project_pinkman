...
pygame.display.set_caption("Pinkman Run")
...
def main(window):
    ...
    fire1 = Fire(25, HEIGHT - (2*block_size) - 64, 16, 32)
    fire2 = Fire(500, HEIGHT - (block_size) - 64, 16, 32)
    fire3 = Fire(895, HEIGHT - (4*block_size) - 64, 16, 32)
    fire4 = Fire(1200, HEIGHT - block_size - 64, 16, 32)
    fire5 = Fire(1650, HEIGHT - block_size - 64, 16, 32)
    fire6 = Fire(-200, HEIGHT - block_size - 64, 16, 32)
    fire7 = Fire(-635, HEIGHT - (4*block_size) - 64, 16, 32)
    
    # Turn on the fire traps
    fire1.on()
    fire2.on()
    fire3.on()
    fire4.on()
    ...
    Block(-block_size * 10, HEIGHT - block_size * 3, block_size),fire1, fire2, fire3, fire4, fire5,fire6,fire7] 
    ...
    while run:
        ...
        if player.lives <= 0:
            font = pygame.font.SysFont('Roman', 175)
        ...
        if remaining_time == 0:  # Check if the elapsed time is 2 minutes
            font = pygame.font.SysFont('Roman', 175)
